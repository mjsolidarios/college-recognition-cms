...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-[95vw] max-w-md -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border border-[var(--color-hairline)] bg-white p-5 shadow-[var(--shadow-panel)] animate-scale-in',
        className,
      )}
      {...props}
    />
